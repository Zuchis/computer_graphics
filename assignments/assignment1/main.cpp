...
// - Create a project to compile, link and run the code provided in this section in your favourite programming environment (course will use VS2015 Community Edition).
